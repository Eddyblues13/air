...
<head>
    ...
    <title>Advanced Package Tracking | Elite Air Delivery</title>
    ...
    <div class="container tracking-container">
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <h1 class="h3 mb-0 text-white">Elite Air Delivery TrackPro</h1>
                    </div>
                    <div>
                        ...
                        <div class="info-card h-100">
                            ...
                            <div class="info-card-body">
                                ...
                                <div class="detail-item">
                                    ...
                                    <div>Elite Air Delivery Express</div>
                                </div>
                                <div class="detail-item">
        ...
        <footer class="rounded-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5>Elite Air Delivery TrackPro</h5>
